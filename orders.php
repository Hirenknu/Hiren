...
<title>Parth Cement Products - Order Detail</title>
...
<div class="main">
    ...
    <section class="order-detail">
        <div class="title">
            <img src="img/logo.png" class="logo" alt="Parth Cement Logo">
            <h1>Order Detail</h1>
            <p>Review your order information, billing details, and status.</p>
        </div>
...
<?php if(file_exists('components/alert.php')) include 'components/alert.php'; ?>
</body>
</html>
